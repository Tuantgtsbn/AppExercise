...
const FinalIntro = ({ navigation }: any) => {
  return (
    <View className='flex-1 items-center justify-between'>
      <View className='items-center mt-[40px]'>
        <Image source={require('@assets/images/Picture4IntroPage.png')} />
        <View className='gap-3 mt-[40px]'>
          <Text className='font-bold text-2xl text-center'>Chào mừng, Stefani</Text>
          <Text className='text-center'>Bạn đã hoàn thành xong cài đặt</Text>

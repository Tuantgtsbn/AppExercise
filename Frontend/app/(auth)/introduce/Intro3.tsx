      ...
      <View className='flex-row justify-content-between'>
        <View className='bg-[#97B8FE] w-[275px] h-[478px] rounded-3xl items-center justify-center'>
          <Image
            ...
            source={require('@assets/images/Picture3IntroPage.png')}
          ></Image>
          <View className='gap-4 mt-4'>
            <Text className='text-white font-bold text-xl text-center'>Giảm béo</Text>
            <Text className='text-white text-center w-[200px]'>
              Tôi phải giảm hơn 20 kg. Tôi muốn giảm hết mỡ và tăng khối lượng cơ
            </Text>
          </View>
        </View>
      </View>

...
interface UpdateHeightModalProps {
  height: number;
  setHeight: (height: number) => void;
}

const UpdateHeightModal: React.FC<UpdateHeightModalProps> = props => {
      ...
      <TouchableOpacity onPress={() => setIsOpen(true)}>
        ...
        >
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <Text style={{ color: '#ADA4A5', fontSize: 10 }}>{height}cm</Text>
...
export default UpdateHeightModal;

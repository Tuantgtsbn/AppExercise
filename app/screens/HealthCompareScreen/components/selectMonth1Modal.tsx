...
interface SelectMonth1ModalProps {
  month1: number;
  setMonth1: (month: number) => void;
}

const SelectMonth1Modal: React.FC<SelectMonth1ModalProps> = props => {
  const { month1, setMonth1 } = props;
      ...
      <TouchableOpacity onPress={() => setIsOpen(true)}>
        ...
        >
          ...
          <View style={styles.row}>
            <Text style={styles.text}>Tháng {`${month1}`}</Text>
...
export default SelectMonth1Modal;
